// Command-driven S3 RIGHT station for the three-ESP32 Version 3 MVP.
...
constexpr uint8_t SENSOR_INDEX = 3;
const char* SENSOR_ID = "s3";
...
void setup() {
  ...
  delay(500);
  configureEspNow();
  Serial.println("V3 S3 right command-driven station ready");
}
